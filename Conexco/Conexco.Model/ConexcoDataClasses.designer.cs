...
namespace Conexco.Model
{
    ...
    partial void OnFechaChanged();
		...
		[Column(Storage="_idPrecio", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idPrecio
		{
			get
			{
    ...
    partial void OnStockChanged();
		...
		[Column(Storage="_idStock", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idStock
		{
			get
			{
