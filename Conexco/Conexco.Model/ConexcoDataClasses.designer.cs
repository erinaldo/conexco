...
namespace Conexco.Model
{
    ...
    partial void InsertArticulos_Precio(Articulos_Precio instance);
    partial void UpdateArticulos_Precio(Articulos_Precio instance);
    partial void DeleteArticulos_Precio(Articulos_Precio instance);
    partial void InsertArticulos_Stock(Articulos_Stock instance);
    partial void UpdateArticulos_Stock(Articulos_Stock instance);
    partial void DeleteArticulos_Stock(Articulos_Stock instance);
    ...
    partial void DeleteRemitos_Linea(Remitos_Linea instance);
		...
		public ConexcoDataClassesDataContext() : 
				base(global::Conexco.Model.Properties.Settings.Default.ConexcoConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Articulos_Precio> Articulos_Precios
		{
			get
			{
				return this.GetTable<Articulos_Precio>();
			}
		}
		
		public System.Data.Linq.Table<Articulos_Stock> Articulos_Stocks
		{
			get
			{
				return this.GetTable<Articulos_Stock>();
			}
		}
	...
	public partial class Articulo : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Articulos_Precio> _Articulos_Precios;
		...
		private EntityRef<Articulos_Color> _Articulos_Color;
    ...
    partial void OnStockChanged();
		...
		public Articulo()
		{
			this._Articulos_Precios = new EntitySet<Articulos_Precio>(new Action<Articulos_Precio>(this.attach_Articulos_Precios), new Action<Articulos_Precio>(this.detach_Articulos_Precios));
			...
			this._Articulos_Color = default(EntityRef<Articulos_Color>);
			OnCreated();
		}
		...
		[Column(Storage="_idColor", DbType="Int")]
		public System.Nullable<int> idColor
		{
			...
			set
			{
				...
				{
					if (this._Articulos_Color.HasLoadedOrAssignedValue)
					{
		...
		[Association(Name="Articulo_Articulos_Precio", Storage="_Articulos_Precios", OtherKey="idArticulo")]
		public EntitySet<Articulos_Precio> Articulos_Precios
		{
			get
			{
				return this._Articulos_Precios;
			}
			set
			{
				this._Articulos_Precios.Assign(value);
			}
		}
		...
		[Association(Name="Articulos_Color_Articulo", Storage="_Articulos_Color", ThisKey="idColor", IsForeignKey=true)]
		public Articulos_Color Articulos_Color
		{
			get
			{
				return this._Articulos_Color.Entity;
			}
			set
			{
				Articulos_Color previousValue = this._Articulos_Color.Entity;
				if (((previousValue != value) 
							|| (this._Articulos_Color.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Articulos_Color.Entity = null;
						previousValue.Articulos.Remove(this);
					}
					this._Articulos_Color.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("Articulos_Color");
				}
			}
		}
		...
		private void attach_Articulos_Precios(Articulos_Precio entity)
		{
			this.SendPropertyChanging();
			entity.Articulo = this;
		}
		
		private void detach_Articulos_Precios(Articulos_Precio entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnRGBChanged();
		...
		[Column(Storage="_idColor", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idColor
		{
			get
			{
		...
		[Association(Name="Articulos_Color_Articulo", Storage="_Articulos", OtherKey="idColor")]
		...
		{
			this.SendPropertyChanging();
			entity.Articulos_Color = this;
		}
		
		private void detach_Articulos(Articulo entity)
		{
			this.SendPropertyChanging();
			entity.Articulos_Color = null;
		}
	}
	
	[Table(Name="dbo.Articulos_Precio")]
	public partial class Articulos_Precio : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnFechaChanged();
		...
		public Articulos_Precio()
		{
			this._Articulo = default(EntityRef<Articulo>);
			OnCreated();
		}
		
		[Column(Storage="_idPrecio", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idPrecio
		{
			get
			{
		...
		[Association(Name="Articulo_Articulos_Precio", Storage="_Articulo", ThisKey="idArticulo", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Articulo.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Articulos_Precios.Remove(this);
					}
					this._Articulo.Entity = value;
					if ((value != null))
					{
						value.Articulos_Precios.Add(this);
	...
	public partial class Articulos_Stock : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnStockChanged();
		...
		public Articulos_Stock()
		{
			OnCreated();
		}
		
		[Column(Storage="_idStock", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idStock
		{
			get
			{
		...
		[Column(Storage="_Stock", DbType="Int NOT NULL")]
		public int Stock
		{
			get
			{
    ...
    partial void OnBajaLogicaChanged();
		...
		[Association(Name="Cliente_Factura", Storage="_Facturas", OtherKey="idCliente")]
		...
		[Association(Name="Cliente_Presupuesto", Storage="_Presupuestos", OtherKey="idCliente")]
    ...
    partial void OnEmailChanged();
		...
		[Column(Storage="_idContacto", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idDomicilio", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idTelefono", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnBajaLogicaChanged();
		...
		[Column(Storage="_idTransportista", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idCondicionIVA", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idCondicionIVA
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idEstado", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idEstado
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idTipoDocumento", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_idMotivo", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idMotivo
		{
			get
			{
    ...
    partial void OnCantidadChanged();
		...
		[Column(Storage="_idEgreso", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idEgreso
		{
			get
			{
    ...
    partial void OnBajaLogicaChanged();
		...
		[Column(Storage="_idFactura", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Cliente_Factura", Storage="_Cliente", ThisKey="idCliente", IsForeignKey=true)]
		public Cliente Cliente
		{
			get
			{
    ...
    partial void OnCantidadChanged();
		...
		[Column(Storage="_idFacturasLinea", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnCodPostalChanged();
		...
		[Column(Storage="_idLocalidad", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnBajaLogicaChanged();
		...
		[Column(Storage="_idPresupuesto", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Cliente_Presupuesto", Storage="_Cliente", ThisKey="idCliente", IsForeignKey=true)]
		public Cliente Cliente
		{
			get
			{
    ...
    partial void OnCantidadChanged();
		...
		[Column(Storage="_idPresupuestosLinea", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnProvincia1Changed();
		...
		[Column(Storage="_idProvincia", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idProvincia
		{
			get
			{
    ...
    partial void OnBajaLogicaChanged();
		...
		[Column(Storage="_idRemito", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int idRemito
		{
			get
			{
    ...
    partial void OnCantidadChanged();
		...
		[Column(Storage="_idRemitosLinea", DbType="Int NOT NULL", IsPrimaryKey=true)]
